...
!function (e, t) {
  ...
  d.fn = d.prototype = {
    ...
    for ("boolean" == typeof s && (l = s, s = arguments[a] || {}, a++), "object" == _typeof(s) || d.isFunction(s) || (s = {}), a === u && (s = this, a--); u > a; a++) {
      if (null != (e = arguments[a])) for (t in e) {
        n = s[t], s !== (r = e[t]) && (l && r && (d.isPlainObject(r) || (i = d.isArray(r))) ? (i ? (i = !1, o = n && d.isArray(n) ? n : []) : o = n && d.isPlainObject(n) ? n : {}, s[t] = d.extend(l, o, r)) : void 0 !== r && (s[t] = r));
      }
    }
    ...
    type: function type(e) {
      return null == e ? e + "" : "object" == _typeof(e) || "function" == typeof e ? a[u.call(e)] || "object" : _typeof(e);
    },
  ...
  var x = function (e) {
    ...
    function re(e, t, r, i) {
      ...
      if (g && !i) {
        if (o = K.exec(e)) if (l = o[1]) {
          ...
          if ((l = o[3]) && n.getElementsByClassName && t.getElementsByClassName) return H.apply(r, t.getElementsByClassName(l)), r;
        }

        if (n.qsa && (!m || !m.test(e))) {
          if (y = v = b, T = t, C = 9 === c && e, 1 === c && "object" !== t.nodeName.toLowerCase()) {
            for (h = s(e), (v = t.getAttribute("id")) ? y = v.replace(ee, "\\$&") : t.setAttribute("id", y), y = "[id='" + y + "'] ", f = h.length; f--;) {
              h[f] = y + he(h[f]);
            }

            T = Z.test(e) && pe(t.parentNode) || t, C = h.join(",");
          }
    ...
    function pe(e) {
      return e && _typeof(e.getElementsByTagName) !== j && e;
    }
    ...
    for (t in n = re.support = {}, o = re.isXML = function (e) {
      ...
      return i !== d && 9 === i.nodeType && i.documentElement ? (d = i, h = i.documentElement, g = !o(i), s && s !== s.top && (s.addEventListener ? s.addEventListener("unload", function () {
        ...
        return _typeof(t.getElementsByTagName) !== j ? t.getElementsByTagName(e) : void 0;
      } : function (e, t) {
        var n,
            r = [],
            i = 0,
        ...
        return _typeof(t.getElementsByClassName) !== j && g ? t.getElementsByClassName(e) : void 0;
      }, v = [], m = [], (n.qsa = J.test(i.querySelectorAll)) && (se(function (e) {
        e.innerHTML = "<select msallowclip=''><option selected=''></option></select>", e.querySelectorAll("[msallowclip^='']").length && m.push("[*^$]=" + M + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || m.push("\\[" + M + "*(?:value|" + P + ")"), e.querySelectorAll(":checked").length || m.push(":checked");
      }), se(function (e) {
        ...
        return r || (1 & (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === r ? e === i || e.ownerDocument === w && x(w, e) ? -1 : t === i || t.ownerDocument === w && x(w, t) ? 1 : c ? F.call(c, e) - F.call(c, t) : 0 : 4 & r ? -1 : 1);
      } : function (e, t) {
        if (e === t) return f = !0, 0;
        var n,
            r = 0,
            ...
            a = [e],
            u = [t];
        if (!o || !s) return e === i ? -1 : t === i ? 1 : o ? -1 : s ? 1 : c ? F.call(c, e) - F.call(c, t) : 0;
        ...
        return r ? ue(a[r], u[r]) : a[r] === w ? -1 : u[r] === w ? 1 : 0;
      }, i) : d;
    }, re.matches = function (e, t) {
      return re(e, null, null, t);
    }, re.matchesSelector = function (e, t) {
      if ((e.ownerDocument || e) !== d && p(e), t = t.replace(X, "='$1']"), !(!n.matchesSelector || !g || v && v.test(t) || m && m.test(t))) try {
        var r = y.call(e, t);
        ...
        CHILD: function CHILD(e, t, n, r, i) {
          ...
          return 1 === r && 0 === i ? function (e) {
            ...
            if (m) {
              ...
              } else if (y && (l = (t[b] || (t[b] = {}))[e]) && l[0] === T) p = l[1];else for (; (f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++p || (y && ((f[b] || (f[b] = {}))[e] = [T, p]), f !== t));) {
                ;
              }
      ...
      pseudos: {
        ...
        lang: oe(function (e) {
          return V.test(e || "") || re.error("unsupported lang: " + e), e = e.replace(te, ne).toLowerCase(), function (t) {
            var n;
    ...
    function ye(e, t, n, r, i, o) {
      return r && !r[b] && (r = ye(r)), i && !i[b] && (i = ye(i, o)), oe(function (o, s, a, u) {
        ...
        if (n && n(m, v, a, u), r) for (l = ve(v, d), r(l, [], a, u), c = l.length; c--;) {
          (f = l[c]) && (v[d[c]] = !(m[d[c]] = f));
        }
        ...
        if (o) {
          if (i || e) {
            ...
            for (c = v.length; c--;) {
              (f = v[c]) && (l = i ? F.call(o, f) : p[c]) > -1 && (o[l] = !(s[l] = f));
            }
          }
        } else v = ve(v === s ? v.splice(h, v.length) : v), i ? i(null, s, v, u) : H.apply(s, v);
      });
    }
    ...
    function xe(e) {
      for (var t, n, i, o = e.length, s = r.relative[e[0].type], a = s || r.relative[" "], u = s ? 1 : 0, c = ge(function (e) {
        ...
        if (n = r.relative[e[u].type]) p = [ge(me(p), n)];else {
          if ((n = r.filter[e[u].type].apply(null, e[u].matches))[b]) {
            for (i = ++u; o > i && !r.relative[e[i].type]; i++) {
              ;
            }

            return ye(u > 1 && me(p), u > 1 && he(e.slice(0, u - 1).concat({
              value: " " === e[u - 2].type ? "*" : ""
            })).replace(I, "$1"), n, i > u && xe(e.slice(u, i)), o > i && xe(e = e.slice(i)), o > i && he(e));
          }
    ...
    function be(e, t) {
      var n = t.length > 0,
        ...
        if (g += m, n && m !== g) {
          ...
          H.apply(u, y), c && !_o && y.length > 0 && g + t.length > 1 && re.uniqueSort(u);
        }
    ...
    return de.prototype = r.filters = r.pseudos, r.setFilters = new de(), s = re.tokenize = function (e, t) {
      ...
      for (a = e, u = [], l = r.preFilter; a;) {
        for (s in (!n || (i = _.exec(a))) && (i && (a = a.slice(i[0].length) || a), u.push(o = [])), n = !1, (i = z.exec(a)) && (n = i.shift(), o.push({
          value: n,
          type: i[0].replace(I, " ")
      ...
      if (i = i || [], 1 === h.length) {
        ...
        for (u = Y.needsContext.test(e) ? 0 : l.length; u-- && (c = l[u], !r.relative[f = c.type]);) {
          if ((p = r.find[f]) && (o = p(c.matches[0].replace(te, ne), Z.test(l[0].type) && pe(t.parentNode) || t))) {
            if (l.splice(u, 1), !(e = o.length && he(l))) return H.apply(i, o), i;
            break;
          }
        }
      }

      return (d || a(e, h))(o, t, !g, i, Z.test(e) && pe(t.parentNode) || t), i;
  ...
  (d.fn.init = function (e, t) {
    ...
    if ("string" == typeof e) {
      ...
      if (n[1]) {
        if (t = t instanceof d ? t[0] : t, d.merge(this, d.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : f, !0)), w.test(n[1]) && d.isPlainObject(t)) for (n in t) {
  ...
  var H = d.access = function (e, t, n, r, i, o, s) {
    var a = 0,
        u = e.length,
        l = null == n;
    if ("object" === d.type(n)) for (a in i = !0, n) {
      d.access(e, t, a, n[a], !0, o, s);
    } else if (void 0 !== r && (i = !0, d.isFunction(r) || (s = !0), l && (s ? (t.call(e, r), t = null) : (l = t, t = function t(e, _t, n) {
      return l.call(d(e), n);
    })), t)) for (; u > a; a++) {
  ...
  d.acceptData = function (e) {
    ...
    set: function set(e, t, n) {
      var r,
          i = this.key(e),
          o = this.cache[i];
      if ("string" == typeof t) o[t] = n;else if (d.isEmptyObject(o)) d.extend(this.cache[i], t);else for (r in t) {
        o[r] = t[r];
      }
      return o;
    },
    ...
    data: function data(e, t) {
      ...
      if (void 0 === e) {
        if (this.length && (i = P.get(o), 1 === o.nodeType && !F.get(o, "hasDataAttrs"))) {
          for (n = s.length; n--;) {
            s[n] && 0 === (r = s[n].name).indexOf("data-") && (r = d.camelCase(r.slice(5)), W(o, r, i[r]));
          }
  ...
  d.event = {
    ...
    add: function add(e, t, n, r, i) {
      var o,
          ...
          m,
          v = F.get(e);
      if (v) for (n.handler && (n = (o = n).handler, i = o.selector), n.guid || (n.guid = d.guid++), (u = v.events) || (u = v.events = {}), (s = v.handle) || (s = v.handle = function (t) {
        return _typeof(d) !== z && d.event.triggered !== t.type ? d.event.dispatch.apply(e, arguments) : void 0;
      }), l = (t = (t || "").match(A) || [""]).length; l--;) {
        h = m = (a = Y.exec(t[l]) || [])[1], g = (a[2] || "").split(".").sort(), h && (f = d.event.special[h] || {}, h = (i ? f.delegateType : f.bindType) || h, f = d.event.special[h] || {}, c = d.extend({
          type: h,
          origType: m,
          data: r,
          handler: n,
    ...
    trigger: function trigger(t, n, r, i) {
      ...
      if (s = a = r = r || f, 3 !== r.nodeType && 8 !== r.nodeType && !V.test(m + d.event.triggered) && (m.indexOf(".") >= 0 && (v = m.split("."), m = v.shift(), v.sort()), c = m.indexOf(":") < 0 && "on" + m, (t = t[d.expando] ? t : new d.Event(m, "object" == _typeof(t) && t)).isTrigger = i ? 2 : 3, t.namespace = v.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : d.makeArray(n, [t]), h = d.event.special[m] || {}, i || !h.trigger || !1 !== h.trigger.apply(r, n))) {
        if (!i && !h.noBubble && !d.isWindow(r)) {
          for (u = h.delegateType || m, V.test(u + m) || (s = s.parentNode); s; s = s.parentNode) {
            g.push(s), a = s;
          }
        ...
        for (o = 0; (s = g[o++]) && !t.isPropagationStopped();) {
          t.type = o > 1 ? u : h.bindType || m, (p = (F.get(s, "events") || {})[t.type] && F.get(s, "handle")) && p.apply(s, n), (p = c && s[c]) && p.apply && d.acceptData(s) && (t.result = p.apply(s, n), !1 === t.result && t.preventDefault());
        }
      ...
      if (u[0] = e, e.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, e)) {
        for (a = d.event.handlers.call(this, e, l), t = 0; (o = a[t++]) && !e.isPropagationStopped();) {
          for (e.currentTarget = o.elem, n = 0; (s = o.handlers[n++]) && !e.isImmediatePropagationStopped();) {
            (!e.namespace_re || e.namespace_re.test(s.namespace)) && (e.handleObj = s, e.data = s.data, void 0 !== (i = ((d.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, u)) && !1 === (e.result = i) && (e.preventDefault(), e.stopPropagation()));
          }
        }
    ...
    handlers: function handlers(e, t) {
      ...
      if (a && u.nodeType && (!e.button || "click" !== e.type)) for (; u !== this; u = u.parentNode || this) {
        if (!0 !== u.disabled || "click" !== e.type) {
          for (r = [], n = 0; a > n; n++) {
            void 0 === r[i = (o = t[n]).selector + " "] && (r[i] = o.needsContext ? d(i, this).index(u) >= 0 : d.find(i, this, null, [u]).length), r[i] && r.push(o);
          }
    ...
    fix: function fix(e) {
      ...
      for (s || (this.fixHooks[i] = s = U.test(i) ? this.mouseHooks : X.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new d.Event(o), t = r.length; t--;) {
        e[n = r[t]] = o[n];
      }
    ...
    on: function on(e, t, n, r, i) {
      ...
      if (null == n && null == r ? (r = t, n = t = void 0) : null == r && ("string" == typeof t ? (r = n, n = void 0) : (r = n, n = t, t = void 0)), !1 === r) r = Q;else if (!r) return this;
  ...
  function fe(e, t) {
    ...
    if (1 === t.nodeType) {
      if (F.hasData(e) && (o = F.access(e), s = F.set(t, o), l = o.events)) for (i in delete s.handle, s.events = {}, l) {
  ...
  se.optgroup = se.option, se.tbody = se.tfoot = se.colgroup = se.caption = se.thead, se.th = se.td, d.extend({
    clone: function clone(e, t, n) {
      ...
      if (!(c.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || d.isXMLDoc(e))) for (s = pe(a), r = 0, i = (o = pe(e)).length; i > r; r++) {
        de(o[r], s[r]);
      }
      if (t) if (n) for (o = o || pe(e), s = s || pe(a), r = 0, i = o.length; i > r; r++) {
        fe(o[r], s[r]);
      } else fe(e, a);
    ...
    buildFragment: function buildFragment(e, t, n, r) {
      for (var i, o, s, a, u, l, c = t.createDocumentFragment(), f = [], p = 0, h = e.length; h > p; p++) {
        if ((i = e[p]) || 0 === i) if ("object" === d.type(i)) d.merge(f, i.nodeType ? [i] : i);else if (ee.test(i)) {
      ...
      for (c.textContent = "", p = 0; i = f[p++];) {
        if ((!r || -1 === d.inArray(i, r)) && (u = d.contains(i.ownerDocument, i), o = pe(c.appendChild(i), "script"), u && ce(o), n)) for (l = 0; i = o[l++];) {
    ...
    remove: function remove(e, t) {
      for (var n, r = e ? d.filter(e, this) : this, i = 0; null != (n = r[i]); i++) {
        t || 1 !== n.nodeType || d.cleanData(pe(n)), n.parentNode && (t && d.contains(n.ownerDocument, n) && ce(pe(n, "script")), n.parentNode.removeChild(n));
      }
    ...
    html: function html(e) {
      return H(this, function (e) {
        ...
        if ("string" == typeof e && !te.test(e) && !se[(Z.exec(e) || ["", ""])[1].toLowerCase()]) {
          ...
          try {
            for (; r > n; n++) {
              1 === (t = this[n] || {}).nodeType && (d.cleanData(pe(t, !1)), t.innerHTML = e);
            }
    ...
    domManip: function domManip(e, t) {
      ...
      if (f && (r = (n = d.buildFragment(e, this[0].ownerDocument, !1, this)).firstChild, 1 === n.childNodes.length && (n = r), r)) {
        for (s = (o = d.map(pe(n, "script"), ue)).length; f > l; l++) {
          a = n, l !== h && (a = d.clone(a, !0, !0), s && d.merge(o, pe(a, "script"))), t.call(this[l], a, l);
        }

        if (s) for (u = o[o.length - 1].ownerDocument, d.map(o, le), l = 0; s > l; l++) {
          a = o[l], re.test(a.type || "") && !F.access(a, "globalEval") && d.contains(u, a) && (a.src ? d._evalUrl && d._evalUrl(a.src) : d.globalEval(a.textContent.replace(oe, "")));
        }
      }
    ...
    d.fn[e] = function (e) {
      for (var n, r = [], i = d(e), s = i.length - 1, a = 0; s >= a; a++) {
        n = a === s ? this : this.clone(!0), d(i[a])[t](n), o.apply(r, n.get());
      }
  ...
  function Le(e, t, n, r, i) {
    for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2) {
      "margin" === n && (s += d.css(e, n + B[o], !0, i)), r ? ("content" === n && (s -= d.css(e, "padding" + B[o], !0, i)), "margin" !== n && (s -= d.css(e, "border" + B[o] + "Width", !0, i))) : (s += d.css(e, "padding" + B[o], !0, i), "padding" !== n && (s += d.css(e, "border" + B[o] + "Width", !0, i)));
    }
  ...
  function He(e, t) {
    for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++) {
      (r = e[s]).style && (o[s] = F.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && I(r) && (o[s] = F.access(r, "olddisplay", ve(r.nodeName)))) : (i = I(r), "none" === n && i || F.set(r, "olddisplay", i ? n : d.css(r, "display"))));
    }
  ...
  var Fe,
    ...
    if (d.isEmptyObject(f)) "inline" === ("none" === l ? ve(e.nodeName) : l) && (p.display = l);else for (r in g ? "hidden" in g && (h = g.hidden) : g = F.access(e, "fxshow", {}), o && (g.hidden = !h), h ? d(e).show() : c.done(function () {
      d(e).hide();
    }), c.done(function () {
      var t;
      ...
      s = ze(h ? g[r] : 0, r, c), r in g || (g[r] = s.start, h && (s.end = s.start, s.start = "width" === r || "height" === r ? 1 : 0));
    }
  }],
      Be = {
    "*": [function (e, t) {
  ...
  function Xe(e, t, n) {
    ...
    for (function (e, t) {
      ...
      for (n in e) {
        if (i = t[r = d.camelCase(n)], o = e[n], d.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (s = d.cssHooks[r]) && ("expand" in s)) for (n in o = s.expand(o), delete e[r], o) {
  ...
  d.fn.extend({
    ...
    attr: function attr(e, t, n) {
      var r,
          i,
          o = e.nodeType;
      if (e && 3 !== o && 8 !== o && 2 !== o) return _typeof(e.getAttribute) === z ? d.prop(e, t, n) : (1 === o && d.isXMLDoc(e) || (t = t.toLowerCase(), r = d.attrHooks[t] || (d.expr.match.bool.test(t) ? Ue : void 0)), void 0 === n ? r && "get" in r && null !== (i = r.get(e, t)) ? i : null == (i = d.find.attr(e, t)) ? void 0 : i : null !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : void d.removeAttr(e, t));
    },
  ...
  d.fn.extend({
    ...
    toggleClass: function toggleClass(e, t) {
      ...
      return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(d.isFunction(e) ? function (n) {
        ...
        if ("string" === n) for (var t, r = 0, i = d(this), o = e.match(A) || []; t = o[r++];) {
  ...
  Ze = st.exec(et.toLowerCase()) || [], d.extend({
    ...
    ajax: function ajax(e, t) {
      ...
      for (l in (u = c.global) && 0 == d.active++ && d.event.trigger("ajaxStart"), c.type = c.type.toUpperCase(), c.hasContent = !it.test(c.type), r = c.url, c.hasContent || (c.data && (r = c.url += (Ke.test(r) ? "&" : "?") + c.data, delete c.data), !1 === c.cache && (c.url = nt.test(r) ? r.replace(nt, "$1_=" + Je++) : r + (Ke.test(r) ? "&" : "?") + "_=" + Je++)), c.ifModified && (d.lastModified[r] && w.setRequestHeader("If-Modified-Since", d.lastModified[r]), d.etag[r] && w.setRequestHeader("If-None-Match", d.etag[r])), (c.data && c.hasContent && !1 !== c.contentType || t.contentType) && w.setRequestHeader("Content-Type", c.contentType), w.setRequestHeader("Accept", c.dataTypes[0] && c.accepts[c.dataTypes[0]] ? c.accepts[c.dataTypes[0]] + ("*" !== c.dataTypes[0] ? ", " + lt + "; q=0.01" : "") : c.accepts["*"]), c.headers) {
  ...
  function yt(e, t, n, r) {
    ...
    if (d.isArray(t)) d.each(t, function (t, i) {
      n || ht.test(e) ? r(e, i) : yt(e + "[" + ("object" == _typeof(i) ? t : "") + "]", i, n, r);
  ...
  e.ActiveXObject && d(e).on("unload", function () {
    ...
    return c.cors || Tt && !e.crossDomain ? {
      send: function send(n, r) {
        ...
        _t2 = function t(e) {
          return function () {
            _t2 && (delete bt[s], _t2 = o.onload = o.onerror = null, "abort" === e ? o.abort() : "error" === e ? r(o.status, o.statusText) : r(wt[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {
              text: o.responseText
            } : void 0, o.getAllResponseHeaders()));
          };
        }, o.onload = _t2(), o.onerror = _t2("error"), _t2 = bt[s] = _t2("abort");
  ...
  d.fn.load = function (e, t, n) {
    ...
    var r,
        ...
        s = this,
        a = e.indexOf(" ");
    return a >= 0 && (r = d.trim(e.slice(a)), e = e.slice(0, a)), d.isFunction(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (i = "POST"), s.length > 0 && d.ajax({
      url: e,
      type: i,
      dataType: "html",
      data: t
    ...
    offset: function offset(e) {
      ...
      var t,
        ...
        left: 0
          ...
          o = r && r.ownerDocument;
      return o ? (t = o.documentElement, d.contains(t, r) ? (_typeof(r.getBoundingClientRect) !== z && (i = r.getBoundingClientRect()), n = St(o), {
